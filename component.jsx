/**
 * v0 by Vercel.
 * @see https://v0.dev/t/bQM4DvOLLoU
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground">
              I'm a creative designer and developer. I love building beautiful and functional websites.
            </p>
          </div>
          <div className="grid gap-4 w-full">
            <Link
              href="#"
              className="flex items-center justify-between bg-muted rounded-md px-4 py-3 hover:bg-muted/50 transition-colors"
              prefetch={false}
            >
